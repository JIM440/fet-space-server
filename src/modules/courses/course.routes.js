...
router.get('/:courseId/persons', authMiddleware(['Student', 'Teacher']), CourseController.getCoursePersons);
router.get('/:courseId/contents', authMiddleware(['Student', 'Teacher']), CourseController.getCourseContents);
router.get('/:courseId/assignments', authMiddleware(['Student', 'Teacher']), CourseController.getCourseAssignments);
router.get('/:courseId/revision-questions', authMiddleware(['Student', 'Teacher']), CourseController.getCourseRevisionQuestions);
